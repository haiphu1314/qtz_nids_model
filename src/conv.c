 ...
 * @ Modified time: 2024-07-10 19:19:55
 * @ Description:
 */
                    ...
                    for (int kc = 0; kc < sizeint_input; kc++)
                    {
                        for (int ky = 0; ky < kernel_size; ky++)
                        {
                            for (int kx = 0; kx < kernel_size; kx++)
                            {
                                ...
                                {
                                    int result_bit = input_quant.b[kc][padded_y][padded_x] ^ layer->weights_b[co][kc][ky][kx];
                        ...
                        for (int ky = 0; ky < kernel_size; ky++)
                        {
                            for (int kx = 0; kx < kernel_size; kx++)
                            {
                                ...
                                else
                                {
                                    ...
                                    //     check = 1;
                                    // }
                                    int result_bit0 = (input_quant.t[kc][padded_y][padded_x].bit_1 & layer->weights_t0[co][kc][ky][kx]) | (input_quant.t[kc][padded_y][padded_x].bit_0 & layer->weights_t1[co][kc][ky][kx]);
                                    int result_bit1 = (input_quant.t[kc][padded_y][padded_x].bit_1 & layer->weights_t1[co][kc][ky][kx]) | (input_quant.t[kc][padded_y][padded_x].bit_0 & layer->weights_t0[co][kc][ky][kx]);
                                    cnt_minus_one += bitCount(result_bit0);
                                    cnt_one += bitCount(result_bit1);
                                }
                                // printf("%d %d %d %d\n",co,kc,ky,kx);
